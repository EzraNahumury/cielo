        ...
        <div className="col-span-12 md:col-span-7 md:pl-10">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute h-[440px] w-[440px] rounded-full border border-white/10"
              aria-hidden
            />
            ...
            >
              <div className="flex items-center justify-between text-[10px] tracking-[0.35em] text-white/40">
                ...
                <span className="text-[color:var(--caleo-cyan)]/85">SEALED</span>
              </div>
              ...
              <div className="mt-14">
                ...
                <div className="mt-3 font-[family-name:var(--font-display)] text-[36px] font-[500] tracking-[0.1em] leading-none text-white md:text-[48px]">
                  CA · 7F2A · 0419
                </div>
              </div>
